...
def LoadAssets ():
    ...
    if gameStart == 1:
        ...
        canvas.image = page
        text_id = canvas.create_text(100*sizeDelta, 515*sizeDelta2, text=names[int(cs) - 1], font=("Ubuntu", 24), fill="red", anchor="w")
        text_id2 = canvas.create_text(100*sizeDelta, 530*sizeDelta2, text=dtext, font=("Ubuntu", 24), fill="black", anchor="nw", width=760*sizeDelta)
    if gameStart == 0:
